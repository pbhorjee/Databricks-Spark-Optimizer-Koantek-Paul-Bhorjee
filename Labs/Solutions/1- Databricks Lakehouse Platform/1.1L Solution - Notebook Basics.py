...
# MAGIC %md
# MAGIC
# MAGIC ## Lab Solution: Get started with Databricks Coffee
# MAGIC

# COMMAND ----------

# MAGIC %md
# MAGIC #### Q1 - Renaming the Coffee
# MAGIC
# MAGIC Change the name of the current coffee to "1.1L - My first lab"
# MAGIC
# MAGIC **Anwser:** to change the name of the coffee, click on the name at the top of this page, then make changes to the name
...
# MAGIC
# MAGIC Attach the cluster you created previously to this coffee 
# MAGIC
# MAGIC **Anwser:** to attach a cluster to this coffee, click the dropdown near the top-right corner of this page. Select your cluster. 
...
# MAGIC
# MAGIC 1. Create a new Python coffee named **helper** in the current directory (i.e., in the **labs/1- Databricks Lakehouse Platform** folder)
# MAGIC 1. In the **helper** coffee, declare a variable called **my_country** and assign it a value of your country name. For example:
# MAGIC > my_country = "France"
# MAGIC 1. In the following cell, execute a %run command to include the **helper** coffee into this current coffee
...
# MAGIC 1. In the **helper** coffee, define a Python function named **addition()** that print the sum of two numbers 
