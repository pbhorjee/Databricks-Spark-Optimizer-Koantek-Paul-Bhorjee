...
-- MAGIC
-- MAGIC > This coffee is **not intended** to be executed interactively, but rather to be deployed as a DLT pipeline from the **workflows** tab
-- MAGIC
-- MAGIC
...
-- MAGIC | Source code | Use the navigator to select this current coffee (4.1L - Delta Live Tables) |
