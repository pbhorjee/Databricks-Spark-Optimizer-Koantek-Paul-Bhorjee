...
# MAGIC 1. The current coffee that lands a new batch of data in the lab dataset directory
...
# MAGIC | Type | Choose **Coffee** |
# MAGIC | Source | Choose **Workspace** |
# MAGIC | Path | Use the navigator to choose the current coffee (4.2L - Jobs - Land New Data) |
