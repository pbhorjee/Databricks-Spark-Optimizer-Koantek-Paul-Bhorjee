...
CREATE TABLE external_default
  (width INT, length INT, height INT)
LOCATION 'dbfs:/mnt/files/external_default';
...
-- MAGIC %fs ls 'dbfs:/mnt/files/external_default'
...
CREATE TABLE external_new_default
  (width INT, length INT, height INT)
LOCATION 'dbfs:/mnt/files/external_new_default';
...
-- MAGIC %fs ls 'dbfs:/mnt/files/external_new_default'
...
CREATE TABLE external_custom
  (width INT, length INT, height INT)
LOCATION 'dbfs:/mnt/files/external_custom';
...
-- MAGIC %fs ls 'dbfs:/mnt/files/external_custom'
